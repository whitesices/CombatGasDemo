...
void AWarriorProjectileBase::HandleApplyProjectileDamage( APawn* InHitPawn, const FGameplayEventData& InPlayload )
{
	...
	//获取是否成功应用的变量
	const bool bWasApplied = UWFunctionLibrary::ApplyGameplayEffectSpecHandleToTarget( GetInstigator() , InHitPawn , ProjectileDamageEffectSpecHandle );
